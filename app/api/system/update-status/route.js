...
const releaseNotes = {
  '2.184.2': [
    ...
    "The product name at the bottom of the page was too faint to read and is now legible.",
  ],
  '2.184.1': [
  ...
  '2.177.3': [
    ...
    "The packaged installer has been rebuilt from the corrected script.",
  ],
  '2.177.2': [
  ...
  '2.164.1': [
    ...
    'Verified on the server directly rather than inferred from the update that shipped it: the page check now completes cleanly and reports all 28 pages rendering.',
    'No change to the product itself — only to the update process and its documentation.',
  ],
  '2.164.0': [
  ...
  '2.159.0': [
    ...
    'The timeout is enforced by the server, not just the browser, so it applies even if the tab is closed or the warning is ignored.',
    'Changing it needs a SecVault-App restart, and the panel shows the saved value beside the one actually in force rather than pretending the change is live.',
  ],
  '2.158.0': [
  ...
  '2.115.1': [
    ...
    'Cut the live queue from 85 items to 45, and the act-now band from 19 to 13, with no finding dropped.',
  ],
  '2.115.0': [
