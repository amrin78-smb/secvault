...
async function main() {
  ...
  if (before.required) {
    ...
    console.log('and they will be prompted to enrol again. resetFor() re-asserts that flag after');
    console.log('clearing the secret, so unlocking an account never silently exempts it.');
  }
