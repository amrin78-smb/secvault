...
// GET /api/v2/monitor/vpn/ssl — active SSL-VPN session list (a MONITOR
// endpoint, not cmdb — operational/live state, not stored config). Added
// 2026-07-19, doc-derived/NOT yet live-verified (see CLAUDE.md's Live
...
// uncertainty.
async function getSslVpnMonitor(conn) {
  return fortiRequest(conn, '/api/v2/monitor/vpn/ssl');
}
