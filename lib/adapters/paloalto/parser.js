...
function normalizeGlobalProtectUsers(entries) {
  ...
  for (const e of list) {
    ...
    out.push({
      ...
      source_ip: pickGpField(e, ['public-ip', 'client-ip', 'public-ipv6', 'source-ip']),
      assigned_ip: pickGpField(e, ['virtual-ip', 'assign-ip', 'virtual-ip-v6']),
...
function normalizeIpsecTunnels(result) {
  ...
  for (const e of entries) {
    ...
    out.push({
      ...
      peer: pickGpField(e, ['peerip', 'peer-ip', 'peer', 'gwip', 'remote-ip', 'gw']),
      status,
