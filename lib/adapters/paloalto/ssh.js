...
class PaloaltoSshAdapter extends FirewallAdapter {
  ...
  //
  // ⛔ Session info is BEST-EFFORT and must never fail the whole call: CPU and
  // memory are the primary readings, and losing them because a secondary
  // command was rejected would make the poll strictly worse than before this
  // existed. Both commands run in ONE session.
