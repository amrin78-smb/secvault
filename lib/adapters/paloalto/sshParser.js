...
// Parses `show running security-policy` output → NormalizedRule[]. Never
// throws — an unparseable/empty blob just yields []; the caller (ssh.js)
// is responsible for distinguishing "this fallback found nothing usable"
// from "this fallback isn't applicable" via looksLikeEffectiveSecurityPolicy()
// first.
