...
//
// ⚠️ DOC-DERIVED, NOT YET LIVE-VERIFIED — this codebase has no live PAN-OS
// device to confirm the exact response shape against (same standing caveat as
// every other unverified field in this file — see CLAUDE.md's "Live
// Validation Status"). `show rule-hit-count` is a real, documented PAN-OS
