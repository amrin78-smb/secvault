...
const COVERAGE = Object.freeze({
  ...
  // ⛔ AWARE, AND SCOPE CHANGES THE COHORTS RATHER THAN JUST FILTERING ROWS.
  // An account granted 2 of the 5 Fortinets gets a cohort of 2, which the
  // engine reports as `insufficient_cohort` and refuses to draw a majority
  // from. That is the correct answer: you cannot say which firewall is the
  // odd one out of a group you cannot see.
  'app/(dashboard)/conformance/page.js': 'aware',
