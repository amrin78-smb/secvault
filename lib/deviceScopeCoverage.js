...
const COVERAGE = Object.freeze({
  ...
  'app/api/analysis/run/route.js': 'no-device-data',
  'app/api/applications/[id]/flows/[flowId]/route.js': 'no-device-data',
  'app/api/applications/[id]/flows/route.js': 'no-device-data',
  'app/api/applications/[id]/retire/route.js': 'blocked',
  'app/api/applications/[id]/route.js': 'no-device-data',
  'app/api/applications/from-cloud/route.js': 'no-device-data',
  'app/api/applications/impact/route.js': 'blocked',
  'app/api/applications/route.js': 'no-device-data',
  ...
  'app/api/compliance/report/generate/route.js': 'no-device-data',
  'app/api/compliance/report/pdf/route.js': 'blocked',
  'app/api/credential-profiles/[id]/route.js': 'no-device-data',
  'app/api/credential-profiles/route.js': 'blocked',
  'app/api/cve/assess/route.js': 'no-device-data',
  ...
  'app/api/discovered-devices/route.js': 'no-device-data',
  ...
  'app/api/rule-change-requests/[id]/export/route.js': 'no-device-data',
  ...
  'app/api/segmentation/route.js': 'no-device-data',
  ...
  'app/(dashboard)/applications/page.js': 'no-device-data',
  ...
  'app/(dashboard)/segmentation/page.js': 'no-device-data',
  'app/(dashboard)/settings/page.js': 'no-device-data',
  'app/(dashboard)/topology/page.js': 'no-device-data',
  ...
  'app/(dashboard)/work/page.js': 'no-device-data',
});
...
module.exports = { COVERAGE, CLASSIFICATIONS, isScopeAware, touchesDeviceData, countByClassification };
