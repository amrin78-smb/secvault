...
async function backfillPaloAltoConfigRedaction(pool) {
  ...
  return { checked, updated, secretsRedacted, leftContainers };
}
...
async function main() {
  ...
  try {
    const { checked, updated, secretsRedacted, leftContainers } =
