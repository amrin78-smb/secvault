...
function parsePaloAlto(message) {
  ...
  return {
    ...
    // fabricated is not.
    srcIp: isTrafficOrThreat ? at(p, PAN_COMMON.srcIp) : null,
    ...
    srcUser: isTrafficOrThreat ? meaningful(at(p, PAN_COMMON.srcUser)) : null,
    ...
    urlCategory: isTraffic ? at(p, PAN_TRAFFIC.urlCategory)
