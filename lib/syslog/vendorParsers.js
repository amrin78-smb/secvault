...
function parsePaloAlto(message) {
  ...
  return {
    ...
    srcUser: meaningful(at(p, PAN_COMMON.srcUser)),
    ...
    urlHostname: isThreat ? meaningful(at(p, PAN_THREAT.url)) : null,
    threatName: isThreat ? meaningful(at(p, PAN_THREAT.threatName)) : null,
