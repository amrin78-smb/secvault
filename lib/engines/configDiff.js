...
// day to five, all still identified purely by SEGMENT NAME (same
// segment-matching approach sectionLabelFor() already uses: split on '.',
// strip `[N]` index suffixes, look for a recognizable segment) -- NOT tied to
// one transport's path prefix, except where noted:
