...
const SECTION_LABELS = [
  ...
  // Top-level rulebase size summary (`security_rules_count`) surfaced by the
  // Palo Alto parser -- a bare count, but "Rule Count" reads better than the
  // generic "Other (Security Rules Count)".
  ['security_rules_count', 'Rule Count'],
  ['nat', 'NAT Rules'],
