...
const DASHBOARD_TABS = [
  ...
  },
  {
    key: 'fleet',
    label: 'Fleet Health',
    description: 'Reachability, vendors, device system health, licences and change history',
  },
  {
    // ⛔ 'Server', NOT 'System'. The tab above is about the FIREWALLS' health
    // and its description used to say "system health" too — one word apart is
    // how someone reads a firewall's CPU as the server's. This one is the box
    // SecVault runs on: disk, database, retention, ingest and services.
    key: 'server',
    label: 'Server',
    description: 'Disk, database size, syslog retention, ingest throughput and service liveness',
  },
];
